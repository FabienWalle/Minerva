 ...
 */
final class Version20250527105146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE book (id SERIAL NOT NULL, title VARCHAR(255) NOT NULL, year VARCHAR(4) DEFAULT NULL, description TEXT DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
